    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div className={`p-2 rounded-xl transition-all duration-300 ${status === 'completed' ? 'bg-green-500/20 text-green-500' :
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm font-bold text-white truncate">{String(data.label || 'Task')}</p>
          </div>
        </div>
